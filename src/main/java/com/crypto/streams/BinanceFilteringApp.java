            ...
            Map<String, KStream<String, String>> branches = sourceStream.split(Named.as("symbol-filter-"))
                .branch((key, value) -> {
                    try {
                        ...
                        // Looking for both "symbol":"BTCUSDT" and "s":"BTCUSDT" formats
                        return value != null && (value.contains("\"symbol\":\"" + BTCUSDT_SYMBOL + "\"") || 
                                                value.contains("\"s\":\"" + BTCUSDT_SYMBOL + "\""));
                    } catch (Exception e) {
                ...
                .branch((key, value) -> {
                    try {
                        ...
                        // Looking for both "symbol":"ETHUSDT" and "s":"ETHUSDT" formats
                        return value != null && (value.contains("\"symbol\":\"" + ETHUSDT_SYMBOL + "\"") || 
                                                value.contains("\"s\":\"" + ETHUSDT_SYMBOL + "\""));
                    } catch (Exception e) {
                ...
                .branch((key, value) -> {
                    try {
                        ...
                        // Looking for both "symbol":"BNBUSDT" and "s":"BNBUSDT" formats
                        return value != null && (value.contains("\"symbol\":\"" + BNBUSDT_SYMBOL + "\"") || 
                                                value.contains("\"s\":\"" + BNBUSDT_SYMBOL + "\""));
                    } catch (Exception e) {
